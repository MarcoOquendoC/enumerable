...
```sh
  cd my-folder
  git clone git@github.com:MarcoOquendoC/enumerable.git
```
### Install
...
- Special Thanks to everyone who will get time to check this code and suggest any [issues](https://github.com/MarcoOquendoC/enumerable/issues)
